...
router
              ...
              return {
                ...
                other_requests: [
                  ...
                  },
                  {
                    ...
                    comment:
                      'YOU_CAN_ALSO_CHANGE_MORE_PROPERTIES_BY_ADDING_MORE_OBJECTS_TO_PAYLOAD_ARRAY_AS_IN_THE_EXAMPLE',
                  },
                ],
              };
            }),
  ...
  .post(upload.single('memberImage'), (req, res, next) => {
